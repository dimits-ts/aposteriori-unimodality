...
\begin{figure}[t]
	...
	\caption{SD of $pol_{obs}$ across comments, averaged across $1000$ runs (Eq.~\ref{eq:observed}). Pol. estimates benefit from more annotators up to $n=20$, where they begin to plateau.}
	\label{fig:std_error}
\end{figure}
