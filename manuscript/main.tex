...
While we can detect polarization \parencite{pavlopoulos-likas-2024}, there is currently no work on how to detect whether it is actually caused by marginalized groups.  \textcite{pavlopoulos-likas-2024} propose a mechanism which only works in the extreme case where polarization is zero; in this work we demonstrate that this case is not frequent in real-world data. % TODO: I will need to demonstrate 
