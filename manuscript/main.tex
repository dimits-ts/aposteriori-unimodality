...
An issue with synthetic datasets is the lack of overall polarization (see Figure~\ref{fig:dataset-polarization-synthetic}). This can be offset by the ability of synthetic datasets to be scaled to a much greater extentn than human datasets. This is because LLMs do not have cost and availability constraints of humans.
