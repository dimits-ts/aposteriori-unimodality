...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.65\textwidth, valign=t]{ndfu_combined.png}
	\includegraphics[width=0.3\textwidth, valign=t]{apriori.png}
