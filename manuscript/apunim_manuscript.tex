...
Unlike disagreement, \ac{ip} does not provide any information, but rather represents noise or uncertainty translated in terms of polarization. In order to minimize it however, we need to find its cause.
