...
Assuming a confidence level of $\alpha=0.05$ we test whether any of the provided \ac{pc} dimensions can explain observed polarization. Statistically significant results are presented in Table~\ref{tab:merged-apunim}. See App.~\ref{app:software} for details on other parameters and execution times, and App.~\ref{app:full} for the full results. The lack of rich annotation data prevents us from analyzing how different annotator groups interact and thus our analysis is necessarily uni-dimensional.
...
\begin{figure*}[t]
	\includegraphics[width=0.8\linewidth]{llm_apunim_grid_default.png}
	\includegraphics[width=0.8\linewidth]{llm_apunim_grid_persona.png}
	\includegraphics[width=0.8\linewidth]{llm_apunim_grid_stereotype.png}
	\includegraphics[width=0.8\linewidth]{llm_apunim_grid_single.png}
	\includegraphics[width=0.8\linewidth]{llm_apunim_grid_direct.png}
