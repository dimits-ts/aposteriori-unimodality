...
parallel --jobs 4 --delay 0.1 \
    ::: \
    'python -m src.variance_analysis --hundred-dataset-path=data/annotation.csv --dices-small-path=data/dices/350/diverse_safety_adversarial_dialog_350.csv --dices-large-path=data/dices/990/diverse_safety_adversarial_dialog_990.csv --graph-output-dir=graphs' \
